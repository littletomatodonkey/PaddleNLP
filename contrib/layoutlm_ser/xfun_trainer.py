...
class XfunReTrainer(XfunSerTrainer):
    ...
    def prediction_step(
            ...
            ignore_keys: Optional[List[str]]=None, ) -> Tuple[Optional[
                float], Optional[paddle.Tensor], Optional[paddle.Tensor]]:
    ...
    def prediction_loop(
        ...
        for step, inputs in enumerate(dataloader):
            ...
            re_labels = labels[1] if re_labels is None else re_labels + labels[
                1]
        ...
        re_metrics = self.compute_metrics(
            EvalPrediction(
                predictions=pred_relations, label_ids=gt_relations))
    ...
    def evaluate(
        ...
        self.args.local_rank = paddle.distributed.get_rank()
